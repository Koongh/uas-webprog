...
<div class="w-4/5 p-4 pb-10">
    ...
    <section class="h-fit lg:h-2/3  sm:h-fit md:h-3/4 md:block md:mb-10 text-gray-600 body-font relative mt-4 mb-8 shadow-md">
        <div class="h-full lg:absolute lg:w-2/3 lg:h-full md:w-full sm:h-full md:h-2/3 inset-0 bg-gray-300">
        ...
        <div class="container lg:h-full md:h-fit md:relative bottom-0 mx-auto flex">
            <div class="lg:w-1/3 lg:h-full md:h-fit  bg-white p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                <h1 class=" 
                    text-center 
                    text-4xl
                    font-extrabold text-transparent bg-clip-text bg-gradient-to-l  from-[#3FC1C9] to-[#1f2937]
